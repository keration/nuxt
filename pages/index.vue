    ...
    <main class="container mx-auto px-4 py-6 max-w-3xl">
      ...
      <div class="text-center mb-8 pt-4">
        <h1 class="text-2xl md:text-3xl font-bold text-gray-800 dark:text-white mb-2 relative">
          我的 Nuxt4 技术博客
          <span class="absolute -bottom-1 left-1/2 transform -translate-x-1/2 w-20 h-0.5 bg-blue-500 rounded-full"></span>
        </h1>
      ...
      <div v-if="error" class="py-8 text-center bg-red-50 dark:bg-red-900/10 rounded-lg p-4">
        <div class=" bg-red-100 dark:bg-red-900/30 text-red-500 dark:text-red-400 rounded-full w-12 h-12 flex items-center justify-center mb-2">
        ...
        <button 
          class="mt-3 px-4 py-1.5 bg-blue-600 text-white rounded text-xs hover:bg-blue-700 transition-colors"
