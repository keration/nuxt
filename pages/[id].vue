      ...
      <div class="container mx-auto px-4 py-3 max-w-5xl flex justify-between items-center">
        ...
        <nav class="flex items-center gap-6">
          ...
          <button @click="toggleDarkMode"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-700 dark:text-gray-300" fill="none"
    ...
    <main class="container mx-auto px-4 py-8 max-w-5xl flex flex-col lg:flex-row gap-8">
      ...
      <div class="flex-1 max-w-3xl">
        ...
        <div v-else
          ...
          <!-- 文章正文（带锚点的HTML） -->
          <div ref="articleContentRef" class="p-6 md:p-8 prose prose-blue prose-lg dark:prose-invert max-w-none"
