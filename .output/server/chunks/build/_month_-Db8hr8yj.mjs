import { v as vueExports, b as useI18n, a as useRoute, s as serverRenderer_cjs_prodExports, k as fetchDefaults, d as useNuxtApp, i as asyncDataDefaults, l as useRequestFetch, h as requireShared_cjs_prod, j as createError } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props) {
    ...
    const fetchArticlesByArchive = async () => {
      ...
      const month = route.params.month.padStart(2, "0");
      try {
        const { data } = await useFetch(
          `/api/articles/filter?year=${year}&month=${month}`,
          "$-C1CaAdTgw"
          /* nuxt-injected */
        );
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (vueExports.unref(articles).length > 0) {
        ...
        serverRenderer_cjs_prodExports.ssrRenderList(vueExports.unref(articles), (article) => {
          ...
          _push(`<p class="text-gray-600 dark:text-gray-400 mt-2">${serverRenderer_cjs_prodExports.ssrInterpolate(article.description)}</p><div class="flex flex-wrap gap-2 mt-3 text-sm"><span class="text-gray-500 dark:text-gray-500">${serverRenderer_cjs_prodExports.ssrInterpolate(vueExports.unref(t)("categories"))}：${serverRenderer_cjs_prodExports.ssrInterpolate(article.category)}</span><span class="text-gray-500 dark:text-gray-500">${serverRenderer_cjs_prodExports.ssrInterpolate(vueExports.unref(t)("tagsLabel"))}${serverRenderer_cjs_prodExports.ssrInterpolate(article.tags.join(", "))}</span></div></div>`);
        });
        _push(`<!--]--></div>`);
      } else {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/archives/[year]/[month].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_month_-Db8hr8yj.mjs.map
