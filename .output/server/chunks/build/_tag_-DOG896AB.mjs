...
const _sfc_main = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props) {
    ...
    const fetchArticlesByTag = async () => {
      ...
      try {
        const response = await $fetch(`/api/article/filter?tag=${encodeURIComponent(tag)}`);
...
//# sourceMappingURL=_tag_-DOG896AB.mjs.map
